...
public class BoardController {
	...
	@Autowired
	public BoardController(Environment env, BoardService boardService, SellFeignClient sellFeignClient) {
		super();
		this.env = env;
	...
	public ResponseEntity<?> getBoard(@PathVariable("sellId") String sellId){
		ResponseEntity<SellFeignResponse> feignResponse = sellFeignClient.findBySellId(sellId);
	...
	public ResponseEntity<?> insert(@RequestHeader("Authorization") String bearerToken, MultipartHttpServletRequest request){
		...
		SellState sellState = SellState.valueOf(request.getParameter("sellState"));
