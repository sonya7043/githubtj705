...
import KakaoMapUpdate from '../sell-service/kakaoMapComponents/KaKaoMapUpdate';
...
function BoardUpdate() {
  ...
  useEffect(() => {
    fetch_General("GET", `http://localhost:8000/board-service/boards/${sellId}`)
      .then(data => {
        setBoard(data)
      })
  }, [sellId])
  ...
  function saveButtonClickHandler() {
    ...
    fetch_multiForm("PUT", `http://localhost:8000/board-service/boards/${sellId}`, formData)
